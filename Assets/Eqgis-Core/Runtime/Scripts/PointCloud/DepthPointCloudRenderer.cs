...
namespace Holo.PointCloud
{
    ...
    /// </summary>
    public class DepthPointCloudRenderer : MonoBehaviour,PointCloudCollect
    {
#if DEBUG_LOG
        private int count = 0;
#endif
        ...
        private const double _minUpdateInvervalInSeconds = 0.1f;//0.07f;100ms更新
        ...
        private void Start()
        {
            ...
            {
                EqLog.e("DepthPointCloudRenderer", "The Material of PointCloud was wrong.");
#if DEBUG_LOG
                //调试情况下，用Toast进行提示
        ...
        private void Update()
        {
            ...
            {
                EqLog.e("DepthPointCloudRenderer", e.Message);
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        private bool CheckPoseChanged()
        {
            Transform camTransform = _cameraManager.transform;
            Vector3 currentPosition = camTransform.position;
            if (Vector3.Distance(currentPosition, lastPostion) > 0.01)
            {
                //位移大于1cm，则认为位置变动
            ...
            if (Quaternion.Angle(currentRotation, lastRotation) > 3.0f)
            {
                //角度大于3度，则任务方向变动
...
//                            + " " + confidenceByte + " " + rgb[0] + " " + rgb[1] + " " + rgb[2]);
...
//        }
        ...
        private void SavePointCloud(string filePath)
        {
            ...
            {
#if DEBUG_LOG
                EqLog.e("DepthPointCloudRenderer", "MeshFilter or Mesh not assigned.");
            ...
            //}
#if DEBUG_LOG
            EqLog.d("DepthPointCloudRenderer", "Mesh saved to " + filePath);
